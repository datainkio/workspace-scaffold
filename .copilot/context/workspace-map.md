...
- [docs/README.md](docs/README.md) — explains intent. Subfolders `docs/decisions/`, `docs/notes/`, `docs/runbooks/` exist and are empty; add runbooks for repeatable tasks.
